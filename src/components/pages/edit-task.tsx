...
import { AddUsers, ExistingTagInput, UserDateInput, UserInput, UserNoteInput, UserStatusInput, UserTextareaInput } from "../inputs/formInputs"
...
export const EditTask = () => {
    ...
    const {user, activeTask, setPage, activeTeam, allData, reloadData} = useUser()
    const {tags} = allData
            ...
            <form 
                ...
                onSubmit={(e) => {
                    ...
                    if(!validations.isValidTask(task)){
                        toast.error("Please fill out the task title, description, and due date")
                        return
                    }
